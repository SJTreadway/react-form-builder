    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.data.element !== 'LineBreak' && this.props.data.allowEdit !== false && _react2.default.createElement(
            "div",
            {
              className: "btn is-isolated btn-school",
              onClick: this.props.editModeOn.bind(this.props.parent, this.props.data)
            },
            _react2.default.createElement("i", { className: "is-isolated fa fa-pencil-square-o" })
          ),
          this.props.data.allowDelete !== false && _react2.default.createElement(
            "div",
            {
              className: "btn is-isolated btn-school",
              onClick: this.props.onDestroy.bind(this, this.props.data)
            },
            _react2.default.createElement("i", { className: "is-isolated fa fa-trash-o" })
          )
        )
      );
    }
