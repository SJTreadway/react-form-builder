      ...
      if (item.required === true) {
        ...
        if (item.type === 'custom' || item.custom) {
          ...
          if (item.element === 'Rating') {
            ...
            if (_$item.value === undefined || _$item.value.length < 1) {
              invalid = true;
            }
          }
        }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'btn-toolbar', style: _extends({}, actionButtonParentStyles) },
              ...
              !this.props.hide_actions && this.props.back_action && _react2.default.createElement(
                'a',
                { href: this.props.back_action, className: 'btn btn-default btn-cancel btn-big' },
                backName
              )
            )
          )
